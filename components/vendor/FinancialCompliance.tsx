...
type Props = {
    country_code: string;
    style?: string;
    register: UseFormRegister<VendorRegisterSchema>;
            ...
            {fields.map((field) => (
                <div key={field.value}>
                    ...
                    <input
                        ...
                        {...register(
                            `financial_details.${field.value}` as keyof VendorRegisterSchema,
                            {
                    ...
                    {errors.financial_details?.[field.value] && (
                        <p className="text-red-500 text-xs mt-1">
                            {errors.financial_details[field.value]?.message as string}
                        </p>
                    )}
                </div>
            ))}
