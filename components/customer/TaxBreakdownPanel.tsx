...
export function TaxBreakdownPanel({
  ...
  if (!tax) {
    return (
      <div className="flex items-center gap-2 py-2.5 px-3 rounded-xl bg-amber-50/70 border border-amber-100 text-xxs sm:text-xs text-amber-700">
    ...
    <div className="border border-gray-100 rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-xs sm:text-sm font-semibold text-gray-700">{TAX_BREAKDOWN_TEXT.TAX_GST}</span>
          {tax.isIntraState ? (
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-xs sm:text-sm font-semibold text-gray-800 tabular-nums">
          ...
          >
            <div className="px-3.5 py-3 bg-white space-y-2 border-t border-gray-100">
              ...
              {(tax.vendorState || tax.customerState) && (
                <div className="flex gap-4 text-xxs text-gray-400 pb-2 border-b border-dashed border-gray-100">
                  {tax.vendorState && (
                    <span>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between text-xs sm:text-sm pt-1.5 border-t border-gray-100">
...
export function TaxLoadingSkeleton() {
  return (
    <div className="flex items-center gap-2 py-2.5 px-3 rounded-xl bg-blue-50/70 border border-blue-100 text-xxs sm:text-xs text-blue-600">
