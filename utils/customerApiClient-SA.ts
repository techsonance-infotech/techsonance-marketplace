...
export const fetchInitCheckout = async (
  userId: string,
  initPayload: any,
  token: string,
) => {
...
export const fetchVerifyPayment = async (
  userId: string,
  verifyPayload: any,
  token: string,
) => {
...
export const fetchCreateUserAddress = async (
  customerId: string,
  addressData: any,
  token: string,
) => {
...
export const fetchUpdateUserAddress = async (
  customerId: string,
  addressId: string,
  addressData: any,
  token: string,
...
export const fetchDeleteUserAddress = async (
  customerId: string,
  addressId: string,
  token: string,
) => {
