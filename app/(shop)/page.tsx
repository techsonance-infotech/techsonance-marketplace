...
import { BEST_SELLING_PRODUCTS, CATEGORY_LIST, FEEDBACK_LIST, HOME_BRAND_FEATURES, PRODUCT_LIST, HERO_BTN_TEXT } from "@/constants/customer";
            ...
            <main className="h-full w-full relative">
                ...
                <section className="xl:px-32 xl:py-2 lg:px-8 md:px-4 sm:px-2 py-1">
                    ...
                    <Link href="/shopping" className="m-auto">
                        <motion.button className="m-auto block bg-linear-to-t from-brand-primary to-brand-secondary text-primary font-bold px-4 py-2 rounded-lg cursor-pointer">{HERO_BTN_TEXT}</motion.button>
                    </Link>
                </section>
