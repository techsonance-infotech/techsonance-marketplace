...
import {
    Key, ShieldCheck, Smartphone, History,
    Monitor, MapPin, LogOut, AlertTriangle,
    Trash2, EyeOff, Eye,
    ChevronRight,
    ChevronLeft
} from "lucide-react";
...
const activeSessions = [
    { id: 1, device: "MacBook Pro - Chrome", location: "Ahmedabad, India", ip: "192.168.1.1", time: "Active now", isCurrent: true, icon: Monitor },
    { id: 2, device: "iPhone 14 Pro - Safari", location: "Ahmedabad, India", ip: "192.168.1.45", time: "2 hours ago", isCurrent: false, icon: Smartphone },
    { id: 3, device: "Windows PC - Edge", location: "Mumbai, India", ip: "103.45.67.89", time: "May 1, 2026", isCurrent: false, icon: Monitor },
];
...
export default function SecuritySettingsPage() {
    ...
    const [otpActionTarget, setOtpActionTarget] = useState<'deactivate' | 'delete'>('deactivate');
    // --- Actions ---
    ...
    const handleDeactivateClick = () => {
        ...
        setConfirmModalConfig({
            ...
            message: "Your profile, orders, and data will be hidden. You can reactivate your account at any time by logging back in. We will send a verification code to your email to confirm this action.",
            actionType: "suspend",
    ...
    const handleVerifyOtp = async (otpCode: string) => {
        setIsProcessing(true);
        console.log(`Verifying OTP: ${otpCode} for action: ${otpActionTarget}`);

        try {
            const res = await AxiosAPI.patch(`/v1/users/${user?.id}/deactivate/confirm`, { otp: otpCode });
        ...
        <div className="w-full max-w-4xl mx-auto pb-12">
            <div className="flex items-start gap-3 my-4 sm:hidden shrink-0" >
                ...
                <div className="flex flex-col gap-0 shrink">
                    ...
                    <p className="text-sm text-gray-500 text-wrap">Manage your password, active sessions, and secure your account.</p>
                </div>
            ...
            <div className="mb-8 hidden lg:block">
                ...
                <p className="text-sm text-gray-500 mt-1">Manage your password, active sessions, and secure your account.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-6">
                <div className="p-6 border-b border-gray-100 flex items-center gap-3 justify-between">
                    ...
                    <Link
                        href={`/customerProfile/${user?.id}/changePassword`}
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-6">
                <div className="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-xl ${is2FAEnabled ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-100 text-gray-500'}`}>
                            <ShieldCheck size={20} />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold text-gray-800">Two-Step Verification (2FA)</h2>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-6">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-gray-800">Where You're Logged In</h2>
                            <p className="text-sm text-gray-500">We'll alert you if anyone logs into your account from a new device.</p>
                        </div>
                    </div>
                ...
                <div className="divide-y divide-gray-100">
                    {activeSessions.map((session) => (
                        <div key={session.id} className="p-6 flex items-start justify-between hover:bg-gray-50/50 transition-colors">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-800 text-sm flex items-center gap-2">
                                        {session.device}
                                        {session.isCurrent && (
                                            <span className="bg-emerald-100 text-emerald-700 text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full">This Device</span>
                                        )}
                                    </p>
            ...
            <div className="bg-white rounded-2xl border border-red-200 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-red-100 bg-red-50/30">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-600/80">Account deactivation and deletion settings.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-100">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-0.5 max-w-md">Temporarily hide your profile and data. You can recover your account by logging in again.</p>
                    </div>
                    <button
                ...
                <div className="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-0.5 max-w-md">Permanently delete your account and all associated data. This cannot be undone.</p>
                    </div>
                    <button
