  ...
  return (
    <div className="p-6 w-full mx-auto">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <Button
          onClick={() => router.push(`/vendor/marketing/campaigns/campaignForm`)}
          ...
          {filtered && filtered.map((c) => {
            ...
            return (
              <div
                ...
                onClick={() => router.push(`/vendor/marketing/campaigns/campaignForm/${c.id}`)}
              >
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    router.push(`/vendor/marketing/campaigns/${c.id}/analytics`);
                  }}
                >
                  View analytics →
                </button>
