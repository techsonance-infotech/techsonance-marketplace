                ...
                <form onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <header className="flex justify-between items-center my-6">
                        ...
                        <span className=" flex justify-between  gap-6 ">
                            ...
                            <input type="submit" className="border-2 border-blue-700 min-w-24 bg-blue-600 text-white py-2 px-4 rounded-lg" value="Publish Product" />
                        </span>
                    </header>
                    <div className="border-2 border-gray-300 p-4 rounded-lg">
                        ...
                        <div>
                            ...
                            <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Enter product name" {...register("productName", { required: "Product Name is required" })} />
                                                ...
                                                <div className="my-4 ">
                                                    <span className="flex justify-between items-center   mt-4 ">
                                                        ...
                                                        <button type="button" onClick={() => remove(index)}
                                                            className="border-2 border-red-500 py-2 px-4 rounded-lg mb-2"><Trash2 size={18} /></button>
                                                    </span>
