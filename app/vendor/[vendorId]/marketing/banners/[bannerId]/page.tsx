        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className={`px-2.5 py-1 text-xs font-semibold rounded-full border ${
              banner.status === 'ACTIVE' ? 'bg-green-50 text-green-700 border-green-200' :
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
             ...
             <div className="space-y-3 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {banner.promotion_id ? (
                      <button 
                        onClick={() => router.push(`/vendor/${vendorId}/marketing/campaigns/campaignForm/${banner.promotion_id}`)}
        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <div className="flex justify-end gap-3 pt-4">
             <Button variant="outline" onClick={() => router.push(`/vendor/${vendorId}/marketing/banners/form/${bannerId}`)}>
               Edit Banner Design
             </Button>
