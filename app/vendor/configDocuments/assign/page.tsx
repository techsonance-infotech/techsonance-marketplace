      ...
      <main className="px-1 py-4 w-full max-w-3xl mx-auto">
        <header className="my-6">
          <h1 className="font-bold text-2xl text-gray-800">
            Assign Product Policy
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Apply rules to an entire category or override them for a specific
            product.
          </p>
        </header>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-600">
                  Where should this policy apply?
                </label>
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  {(targetType === "category" ? categories : products).map(
                    (item) => (
