        ...
        <main className="w-full px-1">
            ...
            <header className="flex justify-between items-center my-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href={`/vendor/finances/gst/new`} className="flex items-center gap-2 font-semibold text-sm bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white rounded-xl px-5 py-2.5 transition-colors shadow-sm">
                        <Plus size={16} />
                        Add GST Number
                    </Link>
                </div>
                        ...
                        {loading ? (
                            ...
                            gstRecords && gstRecords?.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td className="p-4">
                                        <Link href={`/vendor/finances/gst/${item.id}`} className="text-xs font-semibold text-emerald-600 hover:text-emerald-800 bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap">
                                            Edit →
                                        </Link>
                                    </td>
                                </tr>
