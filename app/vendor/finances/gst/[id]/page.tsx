    ...
    return (
        <main className="w-full   px-1">
            <header className="flex justify-between items-center my-6">
                ...
                <Link href={`/vendor/finances/gst`} className="flex items-center gap-2 text-sm bg-white border border-gray-200 text-gray-700 rounded-xl px-5 py-2.5 shadow-sm hover:bg-gray-50">
