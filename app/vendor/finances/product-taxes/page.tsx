                        ...
                        {loading ? (
                            ...
                            productTaxes.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td className="p-4">
                                        <Link href={`/vendor/products/${item.id}`} className="font-semibold text-blue-600 hover:underline line-clamp-2 text-sm text-wrap max-w-24">
                                            {item.product_name}
                                        </Link>
                                    </td>
                        ...
                        <form onSubmit={handleAssignTax} className="p-6">
                            ...
                            {availableRates.length === 0 && (
                                <p className="text-xs text-amber-600 mt-2">
                                    You have no tax rates configured. <Link href={`/vendor/finances/tax-rates/new`} className="underline font-bold">Create one here.</Link>
                                </p>
                            )}
