...
export default function Home() {
  ...
  const homepageLayout = themeData?.homepage_layout || ["hero", "categories", "products", "promo", "new_arrivals", "newsletter"];
  ...
  const renderDesktopSection = (sectionKey: string) => {
    switch (sectionKey) {
      case 'hero':
        return (
          <div key="hero">
      ...
      case 'categories':
        return (
          <section key="categories" className="py-20 px-12 xl:px-20 bg-white">
      ...
      case 'products':
        return (
          <section key="products" className="py-20 px-12 xl:px-20 bg-[#faf9f6]">
      ...
      case 'promo':
        return (
          <section key="promo" className="relative w-full h-[50vh] flex items-center justify-center text-center overflow-hidden">
            {isLoading ? (
              <div className="absolute inset-0 bg-gray-200 animate-pulse" />
            ) : (
              <Image src={getField('middle_banner_image_url')} alt="Promo" fill className="object-cover animate-fade-in" />
            )}
      ...
      case 'new_arrivals':
        return (
          <section key="new_arrivals" className="py-20 px-12 xl:px-20 bg-white">
            <div className="mb-12">
      ...
      case 'newsletter':
        return (
          <section key="newsletter" className="bg-[#0b0c10] text-white py-24 px-12 xl:px-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-xl mx-auto">
              ...
              {subscribed ? (
                <div className="p-4 bg-white/10 backdrop-blur-md rounded-md text-sm font-semibold tracking-wide text-theme-primary">
  ...
  const renderMobileSection = (sectionKey: string) => {
    switch (sectionKey) {
      case 'hero':
        return (
          <div key="m-hero">
      ...
      case 'products':
        return (
          <section key="m-products" className="py-6 px-4 bg-gray-50/50">
      ...
      case 'promo':
        return (
          <section key="m-promo" className="my-6 mx-4">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased overflow-x-hidden">
      ...
      <div className="hidden lg:block">
        {homepageLayout.map((sectionKey) => renderDesktopSection(sectionKey))}
      </div>
      ...
      <div className="block lg:hidden min-h-screen bg-background">
        {homepageLayout.map((sectionKey) => renderMobileSection(sectionKey))}

        {/* Mobile Navigation bar spacer */}
        <div className="h-16" />

        {/* Mobile bottom navigation bar */}
        <nav className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-md border-t border-gray-100 h-16 flex justify-around items-center z-50 shadow-[0_-2px_10px_rgba(0,0,0,0.03)]">
          <Link href="/" className="flex flex-col items-center text-theme-primary">
            <Globe size={18} />
