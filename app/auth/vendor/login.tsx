...
export function VendorLogin() {
    const { isAuthenticated, user, loading, error, token } = useSelector((state: any) => state.auth);
        ...
        <>
            <main className="flex font-[roboto] justify-center items-center border h-[100vh] gap-16">
                ...
                <form
                    ...
                    className="flex flex-col border rounded-2xl px-9 h-[620px] w-[540px] justify-center"
                >
                    ...
                    <p className="text-center text-balance text-slate-500">
                        ...
                        <Link to={`/auth/vendorRegister`} className="text-blue-500 underline ml-1">Create Business account</Link>
                    </p>
                </form>

                <img src={poster} alt="Vendor Login Poster" className="lg:h-[330px] lg:w-[455px] md:h-[300px] md:w-[400px]" />
            </main>
            <Outlet />
        </>
    );
