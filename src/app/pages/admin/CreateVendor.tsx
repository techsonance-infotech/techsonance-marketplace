                ...
                <form onSubmit={handleSubmit((data) => console.log(data))}>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <span className="flex justify-between gap-6 ">
                                ...
                                <div className="flex flex-2 flex-col">
                                    ...
                                    <input className="form_input" placeholder="Enter Business Owner Full Name" type="text" {...register("businessOwnerFullName", { required: "Business Owner Full Name is required" })} name="businessOwnerFullName" id="businessOwnerFullName" />
                                </div>
                                <div className="flex  flex-1 flex-col">
                    ...
                    <div className="rounded-xl border-2 border-gray-200 px-6 py-6  mb-6 ">
                        ...
                        <div className="w-full flex mt-3">
                            <input id="instanceConfig" {...register('instanceConfig', { required: "Instance Configuration is required" })} className="border-2 flex-2 border-gray-200 px-4 py-2 rounded-l-xl" name="instanceConfig" />< p className="border-2 flex-1 bg-gray-200 border-gray-300 px-4 py-2 rounded-r-xl">.platform.com</p>
                        </div>
                    ...
                    <div className="rounded-xl border-2 border-gray-200 px-6 py-6  mb-6  font-medium">
                        ...
                        <div className="w-full flex gap-6 mt-4">
                            ...
                            <div className="w-full   flex flex-1 flex-col justify-between ">
                                ...
                                <select name="category" className="form_select" id="category">
                        ...
                        <div className="w-full flex gap-6 items-center mt-4">
                            ...
                            <div className="w-full flex-2  flex  flex-col justify-between ">
                                ...
                                <input type="text" className="form_input" {...register("vendorAdminLoginEmail", { required: "Vendor Admin Email is required" })} placeholder="admin@vendor.com" name="vendorAdminEmail" id="vendorAdminEmail" />
                            </div>
                    ...
                    <div className="flex justify-end gap-6 mb-6">
                        ...
                        <Link className="border border-gray-300 bg-gray-200 px-4 py-2 rounded-lg" to={'/admin/vendorManagement'}>Cancel</Link>
