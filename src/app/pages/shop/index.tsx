...
import { BEST_SELLING_PRODUCTS, CATEGORY_LIST, HOME_BRAND_FEATURES } from "../../../utils/customer/constants";
        ...
        <>
            <main className="h-full w-full relative  ">
                ...
                <section className="xl:px-32 xl:py-2 lg:px-8 md:px-4 sm:px-2 py-1">
                    ...
                    <Button className="m-auto block  bg-linear-to-t from-band-primary to-brand-secondary text-primary font-bold">Shop Now</Button>
                </section>
                <section className="flex justify-between gap-16 mt-14  flex-wrap bg-primary xl:pt-10 pb-8 xl:px-32   lg:px-8 md:px-4 sm:px-2 py-1">
                    {Array.isArray(features) && features.map((feature, idx) => (
                        <div key={idx} className="flex flex-col items-center gap-4 p-2" >
                            <span className="bg-linear-to-t from-band-primary to-brand-secondary p-3 rounded-full ">
                ...
                <BestSelling product={BEST_SELLING_PRODUCTS} />
